...
func getTableSBInfo(id string) string {
	...
	graph += createRowSBRpt("sb_inodos_count", strconv.Itoa(int(sb.S_inodes_count)))
	graph += createRowSBRpt("sb_bloques_count", strconv.Itoa(int(sb.S_blocks_count)))
	...
	graph += createRowSBRpt("sb_magic_num", strconv.Itoa(int(sb.S_magic)))
